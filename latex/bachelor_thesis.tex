...
*/
vector<complex<SampleType>> SFF::MultipyByComplexSinusoid(const SignalSource& wav, int normalizedFrequency) {
...
\begin{lstlisting}
/***
* Compute the threshold beta usiing histogram
*/
...
\begin{figure}
	...
	\begin{center}
		$\begin{array}{ | l | l | l | l | l | }
			...
			$\bfseries$\textrm{SUMA RÓŻNIC} &$\bfseries 0$ &$\bfseries 2177$ &$\bfseries 222982$ &$\bfseries 5141$ \\ \hline
			$\bfseries$\textrm{Ilość detekcji} &$\bfseries 46$ &$\bfseries 60$ &$\bfseries 44$ &$\bfseries 72$ \\ \hline
			$\bfseries$ \textrm{Wynik} &$\bfseries 0 $&$\bfseries 72177$ &$\bfseries 232982$ &$\bfseries 135141$ \\ \hline
		\end{array}$
...
\begin{figure}
	...
	\begin{center}
		...
		$\bfseries$\textrm{SUMA RÓŻNIC} & $\bfseries$0 & $\bfseries$8764 & $\bfseries$281165 & $\bfseries$261005 \\ \hline
		$\bfseries$\textrm{Ilość detekcji} & 54 & 50 & 40 & 28 \\ \hline
		$\bfseries$\textrm{Wynik} & 0 & 28764 & 351165 & 391005 \\ \hline
		\end{array}
		$
